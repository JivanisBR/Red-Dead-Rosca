...
Texture2D cb1, cb1i, cb2, cb2i, chapeu1, chapeu2, credits, menui, logo, modoi, makeyourchoices;
...
const float GRAVIDADE_PARTICULA = 0.2f;
...
int main(void)
{
    ...
    makeyourchoices = LoadTexture("makeyourchoices.png");
    ...
    UnloadTexture(back); UnloadTexture(pauser); UnloadTexture(cb1); UnloadTexture(cb1i); UnloadTexture(makeyourchoices);
...
void bangbanger(){
    ...
    for (int i = 0; i < MAX_BALAS; i++){
        if(bala1_ativo[i] == 1){
            ...
            Rectangle recBala1 = { (float)bala1v_x[i], (float)bala1v_y[i], 20, 3 }; // Retangulo da bala
            ...
            if (CheckCollisionRecs(recBala1, recBot)) {
                ...
                if(qntsang2 >= 1){ sang21 = true; if(inv2==false){sang2x1=cb2_x+80;}else{sang2x1=cb2_x-15;} sang2y1 = cb2_y + 50; tamsang2x1 = GetRandomValue(10, 30)/3.0f; tamsang2y1 = tamsang2x1; cont2sang1 = GetRandomValue(30, 60); sang2_vel_x1 = GetRandomValue(10, -1)/3.0f; sang2_vel_y1 = GetRandomValue(-1, 1); }
                if(qntsang2 >= 2){ sang22 = true; if(inv2==false){sang2x2=cb2_x+80;}else{sang2x2=cb2_x-15;} sang2y2 = cb2_y + 50; tamsang2x2 = GetRandomValue(10, 30)/3.0f; tamsang2y2 = tamsang2x2; cont2sang2 = GetRandomValue(30, 60); sang2_vel_x2 = GetRandomValue(10, -1)/3.0f; sang2_vel_y2 = GetRandomValue(-1, 1); }
                if(qntsang2 >= 3){ sang23 = true; if(inv2==false){sang2x3=cb2_x+80;}else{sang2x3=cb2_x-15;} sang2y3 = cb2_y + 50; tamsang2x3 = GetRandomValue(10, 30)/3.0f; tamsang2y3 = tamsang2x3; cont2sang3 = GetRandomValue(30, 60); sang2_vel_x3 = GetRandomValue(10, -1)/3.0f; sang2_vel_y3 = GetRandomValue(-1, 1); }
                if(qntsang2 >= 4){ sang24 = true; if(inv2==false){sang2x4=cb2_x+80;}else{sang2x4=cb2_x-15;} sang2y4 = cb2_y + 50; tamsang2x4 = GetRandomValue(10, 30)/3.0f; tamsang2y4 = tamsang2x4; cont2sang4 = GetRandomValue(30, 60); sang2_vel_x4 = GetRandomValue(10, -1)/3.0f; sang2_vel_y4 = GetRandomValue(-1, 1); }
                if(qntsang2 == 5){ sang25 = true; if(inv2==false){sang2x5=cb2_x+80;}else{sang2x5=cb2_x-15;} sang2y5 = cb2_y + 50; tamsang2x5 = GetRandomValue(10, 30)/3.0f; tamsang2y5 = tamsang2x5; cont2sang5 = GetRandomValue(30, 60); sang2_vel_x5 = GetRandomValue(10, -1)/3.0f; sang2_vel_y5 = GetRandomValue(-1, 1); }
        ...
        if(bala2_ativo[i] == 1 && pause==false && timer_inicio<1){
            ...
            Rectangle recBala2 = { (float)bala2v_x[i], (float)bala2v_y[i], 20, 3 }; // Retangulo da bala 2
            Rectangle recJogador = { hb1x, hb1y, 30, 120 }; // Hitbox do jogador

            if (CheckCollisionRecs(recBala2, recJogador)) {
                vida -= DANOO; qntsang = GetRandomValue(2,5);
                TocarSomHitAleatorio();
                if(qntsang >= 1){ sang1 = true; if(inv1==false){sangx1=cb_x-20;}else{sangx1=cb_x+70;} sangy1 = cb_y + 50; tamsangy1 = GetRandomValue(10, 30)/3.0f; tamsangx1 = tamsangy1; contsang1 = GetRandomValue(30, 60); sang_vel_x1 = GetRandomValue(-10, 1); sang_vel_y1 = GetRandomValue(-1, 1); }
                if(qntsang >= 2){ sang2 = true; if(inv1==false){sangx2=cb_x-20;}else{sangx2=cb_x+70;} sangy2 = cb_y + 50; tamsangy2 = GetRandomValue(10, 30)/3.0f; tamsangx2 = tamsangy2; contsang2 = GetRandomValue(30, 60); sang_vel_x2 = GetRandomValue(-10, 1); sang_vel_y2 = GetRandomValue(-1, 1); }
                if(qntsang >= 3){ sang3 = true; if(inv1==false){sangx3=cb_x-20;}else{sangx3=cb_x+70;} sangy3 = cb_y + 50; tamsangy3 = GetRandomValue(10, 30)/3.0f; tamsangx3 = tamsangy3; contsang3 = GetRandomValue(30, 60); sang_vel_x3 = GetRandomValue(-10, 1); sang_vel_y3 = GetRandomValue(-1, 1); }
                if(qntsang >= 4){ sang4 = true; if(inv1==false){sangx4=cb_x-20;}else{sangx4=cb_x+70;} sangy4 = cb_y + 50; tamsangy4 = GetRandomValue(10, 30)/3.0f; tamsangx4 = tamsangy4; contsang4 = GetRandomValue(30, 60); sang_vel_x4 = GetRandomValue(-10, 1); sang_vel_y4 = GetRandomValue(-1, 1); }
                if(qntsang == 5){ sang5 = true; if(inv1==false){sangx5=cb_x-20;}else{sangx5=cb_x+70;} sangy5 = cb_y + 50; tamsangy5 = GetRandomValue(10, 30)/3.0f; tamsangx5 = tamsangy5; contsang5 = GetRandomValue(30, 60); sang_vel_x5 = GetRandomValue(-10, 1); sang_vel_y5 = GetRandomValue(-1, 1); }
    ...
    if(dead1 == 0){
        if(sang1){ if(inv1==false){ sangx1 += sang_vel_x1; } else{ sangx1 -= sang_vel_x1; } sangy1 += sang_vel_y1; sang_vel_y1 += GRAVIDADE_PARTICULA; tamsangx1=tamsangx1-0.2f; tamsangy1=tamsangy1-0.5f; contsang1--; if(contsang1 > 0 && tamsangx1 > 0){ DrawEllipse(sangx1, sangy1, tamsangx1, tamsangy1, RED); } else { sang1 = false; } }
        if(sang2){ if(inv1==false){ sangx2 += sang_vel_x2; } else{ sangx2 -= sang_vel_x2; } sangy2 += sang_vel_y2; sang_vel_y2 += GRAVIDADE_PARTICULA; tamsangx2=tamsangx2-0.2f; tamsangy2=tamsangy2-0.5f; contsang2--; if(contsang2 > 0 && tamsangx2 > 0){ DrawEllipse(sangx2, sangy2, tamsangx2, tamsangy2, RED); } else { sang2 = false; } }
        if(sang3){ if(inv1==false){ sangx3 += sang_vel_x3; } else{ sangx3 -= sang_vel_x3; } sangy3 += sang_vel_y3; sang_vel_y3 += GRAVIDADE_PARTICULA; tamsangx3=tamsangx3-0.2f; tamsangy3=tamsangy3-0.5f; contsang3--; if(contsang3 > 0 && tamsangx3 > 0){ DrawEllipse(sangx3, sangy3, tamsangx3, tamsangy3, RED); } else { sang3 = false; } }
        if(sang4){ if(inv1==false){ sangx4 += sang_vel_x4; } else{ sangx4 -= sang_vel_x4; } sangy4 += sang_vel_y4; sang_vel_y4 += GRAVIDADE_PARTICULA; tamsangx4=tamsangx4-0.2f; tamsangy4=tamsangy4-0.5f; contsang4--; if(contsang4 > 0 && tamsangx4 > 0){ DrawEllipse(sangx4, sangy4, tamsangx4, tamsangy4, RED); } else { sang4 = false; } }
        if(sang5){ if(inv1==false){ sangx5 += sang_vel_x5; } else{ sangx5 -= sang_vel_x5; } sangy5 += sang_vel_y5; sang_vel_y5 += GRAVIDADE_PARTICULA; tamsangx5=tamsangx5-0.2f; tamsangy5=tamsangy5-0.5f; contsang5--; if(contsang5 > 0 && tamsangx5 > 0){ DrawEllipse(sangx5, sangy5, tamsangx5, tamsangy5, RED); } else { sang5 = false; } }
        if(abx == 0){
    ...
    if(dead2 == 0){
        if(sang21){ if(inv2==false){ sang2x1 += sang2_vel_x1; } else{ sang2x1 -= sang2_vel_x1; } sang2y1 += sang2_vel_y1; sang2_vel_y1 += GRAVIDADE_PARTICULA; tamsang2x1=tamsang2x1-0.2f; tamsang2y1=tamsang2y1-0.5f; cont2sang1--; if(cont2sang1 > 0 && tamsang2x1 > 0){ DrawEllipse(sang2x1, sang2y1, tamsang2x1, tamsang2y1, RED); } else { sang21 = false; } }
        if(sang22){ if(inv2==false){ sang2x2 += sang2_vel_x2; } else{ sang2x2 -= sang2_vel_x2; } sang2y2 += sang2_vel_y2; sang2_vel_y2 += GRAVIDADE_PARTICULA; tamsang2x2=tamsang2x2-0.2f; tamsang2y2=tamsang2y2-0.5f; cont2sang2--; if(cont2sang2 > 0 && tamsang2x2 > 0){ DrawEllipse(sang2x2, sang2y2, tamsang2x2, tamsang2y2, RED); } else { sang22 = false; } }
        if(sang23){ if(inv2==false){ sang2x3 += sang2_vel_x3; } else{ sang2x3 -= sang2_vel_x3; } sang2y3 += sang2_vel_y3; sang2_vel_y3 += GRAVIDADE_PARTICULA; tamsang2x3=tamsang2x3-0.2f; tamsang2y3=tamsang2y3-0.5f; cont2sang3--; if(cont2sang3 > 0 && tamsang2x3 > 0){ DrawEllipse(sang2x3, sang2y3, tamsang2x3, tamsang2y3, RED); } else { sang23 = false; } }
        if(sang24){ if(inv2==false){ sang2x4 += sang2_vel_x4; } else{ sang2x4 -= sang2_vel_x4; } sang2y4 += sang2_vel_y4; sang2_vel_y4 += GRAVIDADE_PARTICULA; tamsang2x4=tamsang2x4-0.2f; tamsang2y4=tamsang2y4-0.5f; cont2sang4--; if(cont2sang4 > 0 && tamsang2x4 > 0){ DrawEllipse(sang2x4, sang2y4, tamsang2x4, tamsang2y4, RED); } else { sang24 = false; } }
        if(sang25){ if(inv2==false){ sang2x5 += sang2_vel_x5; } else{ sang2x5 -= sang2_vel_x5; } sang2y5 += sang2_vel_y5; sang2_vel_y5 += GRAVIDADE_PARTICULA; tamsang2x5=tamsang2x5-0.2f; tamsang2y5=tamsang2y5-0.5f; cont2sang5--; if(cont2sang5 > 0 && tamsang2x5 > 0){ DrawEllipse(sang2x5, sang2y5, tamsang2x5, tamsang2y5, RED); } else { sang25 = false; } }
        if(abx2 == 0){
    ...
    if(menu==false && modo==false && quit==false && bangmenu==false){
        ...
        if (oneshot == true) {
            ...
            if (os_estado == 1 && pause==false) {
                DrawTexture(makeyourchoices, 0, 0, WHITE);
        ...
        if(dead1==0 && dead2>0 && bangbang==true){ 
            ...
            dnv=1; 
            if(IsKeyPressed(KEY_R)){ 
                win1++; vida=100; vida2=100; dnv=0; dead1=0; dead2=0; mun=6; mun2=6; fall=0; fall2=0; bala_x=cb_x+53; bala2_x=cb2_x-10; cb_x=100; cb2_x=1100; cb_y=560; cb2_y=560; hb1x=cb_x+10; hb1y=cb_y+10; hb2x=cb2_x+40; hb2y=cb2_y+10; tamsangy1=0; tamsangy2=0; tamsangy3=0; tamsangy4=0; tamsangy5=0; cont2sang1=0; cont2sang2=0; cont2sang3=0; cont2sang4=0; cont2sang5=0;
                ...
                vel_y1 = 0.0; vel_y2 = 0.0; pulando1 = false; pulando2 = false; sangx1=cb_x-30; sangy1=cb_y+40; tem_chapeu1 = true; tem_chapeu2 = true; r1=false; r2=false; r1c=600; r2c=600; reload1=0; reload2=0;
            } 
        }
        if(dead2==0 && dead1>0 && bangbang==true){ 
            ...
            dnv=1; 
            if(IsKeyPressed(KEY_R)){ 
                win2++; vida=100; vida2=100; dnv=0; dead1=0; dead2=0; mun=6; mun2=6; fall=0; fall2=0; bala_x=cb_x+53; bala2_x=cb2_x-10; cb_x=100; cb2_x=1100; cb_y=560; cb2_y=560; hb1x=cb_x+10; hb1y=cb_y+10; hb2x=cb2_x+40; hb2y=cb2_y+10; tamsangy1=0; tamsangy2=0; tamsangy3=0; tamsangy4=0; tamsangy5=0; cont2sang1=0; cont2sang2=0; cont2sang3=0; cont2sang4=0; cont2sang5=0;
                for (int i=0; i<MAX_BALAS; i++){ bala1_ativo[i] = 0; bala2_ativo[i] = 0; } 
                cooldown1 = 0; cooldown2 = 0; vel_x_knock1 = 0.0; vel_x_knock2 = 0.0; vel_x_morte1 = 0.0; vel_y_morte1 = 0.0; morrendo1 = false; vel_x_morte2 = 0.0; vel_y_morte2 = 0.0; morrendo2 = false; 
                vel_y1 = 0.0; vel_y2 = 0.0; pulando1 = false; pulando2 = false; sangx1=cb_x-30; sangy1=cb_y+40; tem_chapeu1 = true; tem_chapeu2 = true; r1=false; r2=false; r1c=600; r2c=600; reload1=0; reload2=0;
            } 
        ...
        if(dead2>0 && dead1>0 && bangbang==true && pause==false){ 
            ...
            dnv=1; 
            if(IsKeyPressed(KEY_R)){ 
                vida=100; vida2=100; dnv=0; dead1=0; dead2=0; mun=6; mun2=6; fall=0; fall2=0; bala_x=cb_x+53; bala2_x=cb2_x-10; cb_x=100; cb2_x=1100; cb_y=560; cb2_y=560; hb1x=cb_x+10; hb1y=cb_y+10; hb2x=cb2_x+40; hb2y=cb2_y+10; tamsangy1=0; tamsangy2=0; tamsangy3=0; tamsangy4=0; tamsangy5=0; cont2sang1=0; cont2sang2=0; cont2sang3=0; cont2sang4=0; cont2sang5=0;
                for (int i=0; i<MAX_BALAS; i++){ bala1_ativo[i] = 0; bala2_ativo[i] = 0; } 
                cooldown1 = 0; cooldown2 = 0; vel_x_knock1 = 0.0; vel_x_knock2 = 0.0; vel_x_morte1 = 0.0; vel_y_morte1 = 0.0; morrendo1 = false; vel_x_morte2 = 0.0; vel_y_morte2 = 0.0; morrendo2 = false; 
                vel_y1 = 0.0; vel_y2 = 0.0; pulando1 = false; pulando2 = false; sangx1=cb_x-30; sangy1=cb_y+40; tem_chapeu1 = true; tem_chapeu2 = true; r1=false; r2=false; r1c=600; r2c=600; reload1=0; reload2=0;
            } 
